...
of PKM—or personal knowledge management.I In the same way that personal  
...
them, known as a “commonplace book.”II
...
consolidate our myriad marginaliaIV into an even more robust commonplace  
...
Throughout the twentieth century, a series of scholars and innovators^7 offered a  
...
your needs get more sophisticated.II  
...
create far more effectively than if they had to do it on their own.^8 They use their  
...
the equation E=mc^2. If he can distill his thinking into such an elegant equation,  
...
All these actions—evaluate, share, teach, record, post, and lobbyVI—are  
...
III. Even if the original web page disappears, you can often use this information to locate an archived version  
...
followers. I eventually named this organizing system PARA,I which stands for the  
four main categories of information in our lives: Projects, Areas, Resources, and  
Archives. These four categories are universal, encompassing _any_ kind of

information, from _any_ source, in _any_ format, for _any_ purpose.II  
PARA can handle it all, regardless of your profession or field, for one reason: it  
organizes information based on _how actionable it is_ , not _what kind of information  
it is_. The project becomes the main unit of organization for your digital files.  
...
putting a note into a folder (or tagging itIII) for a specific project, such as a  
...
discover that some notes and resources are no longer actionable. I’ll show you  
...
software program, but to use a single _organizing system_ , one that provides
...
As an article in the _New York Times_^3 explains, “A project is identified; a team is  
...
```
Projects at work: Complete web-page design; Create slide deck for
conference; Develop project schedule; Plan recruitment drive.
Personal projects: Finish Spanish language course; Plan vacation; Buy new
...
While there is no goal to reach, there is a _standard_ that you want to uphold in  
...
```
What topics are you interested in? Architecture; Interior design; English
literature; Beer brewing.
```

```
What subjects are you researching? Habit formation; Notetaking;
...
```
Which hobbies or passions do you have? Coffee; Classic movies; Hip-
...
Resources that are no longer relevant (hobbies you lose interest in or
...
I’ve accumulated over the years: the top-level PARA categories, the project folder,  
...
Inside these folders live the files that I use to execute each project. Here is the  
project folder dedicated to the book you’re reading right now:

### Where Do I Put This?—How to Decide Where to Save
...
```
Projects are most actionable because you’re working on them right now and
...
will be useful, but where it will be useful the _soonest_. By placing a note in a project  
...
Imagine how absurd it would be to organize a kitchen instead by _kind of food_ :  
...
Instead of organizing ideas according to _where they come from_ , I recommend  
organizing them according to _where they are going—_ specifically, the outcomes  
...
Not once did someone come back and say, “You know, I’d really like to go  
...
Second, I learned that creating new things is what really matters. I’d see a fire  
...
I’ve learned that completed creative projects are the blood flow of your Second  
...
```
Notice what’s on your mind: What’s worrying you that you haven’t
...
```
Look at your to-do list: What actions are you already taking that are
...
```
Look at your computer desktop, downloads folder, documents
...
I. _Para_ is a Greek word that means “side by side,” as in “parallel”; this convenient definition reminds us that  
our Second Brain works “side by side” with our biological brain.

II. As you can probably tell, I’m a big fan of four-letter frameworks. Researchers have called it the “Magic  
Number 4” because it is the highest number that we can count at a glance and hold in our minds without  
extra effort.

III. I will use the term “folder” to refer to the main unit of organization used by most notes apps; some  
...
# In 1969, studio executives at Paramount Pictures were desperate to find a film
...
make was, of course, _The Godfather_.  
Coppola initially turned down the project. As recounted in the _Hollywood_

_Reporter_ ,^1 he said, “It was more commercial and salacious than my own taste.”  
However, his partner and protégé George Lucas (of future _Star Wars_ fame) noted  
...
_The Godfather_ would go on to become one of the greatest critical and  
...
book.” He started by reading _The Godfather_ novel and capturing the parts that  
...
In a short documentary titled _Francis Coppola’s Notebook_^3 released in 2001,  
...
I’ve shown you how to capture notes with interesting ideas from the outside  
...
You’re watching a YouTube video on home renovation now, but that  
...
the future is their _discoverability_ —how easy it is to discover what they contain and  
...
database, or other information system.”I Librarians think about discoverability  
...
highlight the main points of _those_ highlights, and so on, distilling the essence of a  
...
Here’s an example of a note I captured from an article in _Psychology Today_.^4 I  
...
notes. Notice that I didn’t save the entire article—only a few key excerpts.III By  
...
it is, I’ll have all the additional details and context I need to remember it right in  
...
the very few sources that are truly unique and valuable, I’ll add an “executive  
...
of my thinking. Looking only at the points I’ve previously bolded and highlighted  
...
two, three, or four. You can _customize_ how much attention you spend on a note  
...
Progressive Summarization helps you focus on the _content_ and the _presentation_

of your notes,IV instead of spending too much time on labeling, tagging, linking,
...
content. As long as a source can be turned into text,V you can add layers of  
...
Luckily, I had a handful of highly actionable notes saved in a resource folder called  
...
enough time to do more research. I had to make use of the ideas I’d already  
...
_Picasso’s Bull_ , offers a master class in how distillation works. It is a sequence of  
...
Pablo Picasso, _Le Taureau_ (series of 11 lithographs), 1945–46 (© 2021 Estate of Pablo Picasso / Artists  
...
capture the very essence of the bull.^6  
...
renowned creator of award-winning films like _The Civil War_ , _Baseball_ , and _Jazz_ ,  
...
amidst hundreds of hours of recordings.VI  
...
should I be doing this highlighting?” The answer is that you should do it _when  
you’re getting ready to create something._  
...
stretching routine.  
When I’m about to get on a call with my lawyer, I’ll often prepare by  
...
make it a little more discoverable for your future selfVII—by adding a highlight, a  
...
to save in the first place, the same rule applies for the insights _within_ the note.  
...
reading books and doing research. You need that research to already be done.VIII  
...
II. I like to think of layer one as the “soil”—an excerpt from a source or my own thinking (whether as words,  
...
III. In his book _A New Method of Making Common-Place-Books_ , John Locke similarly advised that “We  
...
VIII. As Sönke Ahrens observes in his book _How to Take Smart Notes_ , this is the fundamental paradox at the  
...
# In June 1947, a baby girl named Octavia Estelle Butler was born in Pasadena,
...
which led her to believe she was “ugly and stupid, clumsy, socially hopeless.”^1 Her  
...
When she was twelve years old, Estelle watched the 1954 film _Devil Girl From  
Mars_ , a sensationalist B movie that was so terrible it convinced Estelle that she  
...
One of Butler’s novels, _The Parable of the Sower_ , hit the _New York Times_

bestseller list for the first time in 2020,^3 fulfilling one of Butler’s life goals fourteen  
...
others. If there is a secret to creativity, it is that it _emerges_ from everyday efforts to  
...
knowledge that _frees up_ attention, instead of taking more of it.  
...
smaller pieces—you then need a _system_ for managing those pieces. Otherwise,  
...
individual building blocks that make up your work.I For example, a set of notes  
...
creative thinking. Thinking _small_ is the best way to elevate your horizons and  
expand your ambitions.  
There are five kinds of Intermediate Packets you can create and reuse in your  
work:

```
Distilled notes: Books or articles you’ve read and distilled so it’s easy to get
...
```
Outtakes: The material or ideas that didn’t make it into a past project but
could be used in future ones.
```

```
Work-in-process: The documents, graphics, agendas, or plans you
produced during past projects.
```

```
Final deliverables: Concrete pieces of work you’ve delivered as part of past
projects, which could become components of something new.
```

```
Documents created by others: Knowledge assets created by people on
...
your notes and turn them into _distilled notes_ for when it’s time to put them to  
use. If you’re writing an essay and decide to cut a paragraph, you can save those  
_outtakes_ in case you ever write a follow-up. If you are in product development and  
create a detailed set of requirements, you can save that _work-in-process_ as a  
template for future products. If you’re a management consultant, you can save  
the slides you presented to an executive team as a _final deliverable_ , and reuse them  
for similar presentations. If you’re a lab scientist and a colleague designs the  
perfect lab protocol, you can reuse and improve that _document_ for your own use  
...
simply _notice_ the IPs that you have already produced and then to take an extra  
...
How could you _acquire_ or _assemble_ each of these components, instead of having  
...
that’s the point! Your Second Brain is the repository of things you are _already_  
...
As powerful as search can be, studies^5 have found that in many situations  
...
where to look next.^6 Browsing allows us to gradually home in on the information  
...
physical environments, and thus comes to us more naturally.II  
...
like _Star Wars_ and _Indiana Jones_. To stay within time and budget, model makers  
...
normally take.  
Adam Savage, host of the popular _MythBusters_ television show and a skilled  
...
particular kit that found its way into almost every model the team ever built.^7  
Don’t take the work of others wholesale; borrow _aspects_ or _parts_ of their work.  
...
toward this turning point. Instead of thinking of your job in terms of _tasks_ , which  
always require you to be there, personally, doing everything yourself, you will start  
to think in terms of _assets_ and _building blocks_ that you can assemble.
...
Giambattista Vico: _Verum ipsum factum_. Translated to English, it means “We  
...
III. Tagging for personal knowledge management is a subject unto itself. While not necessary to get started,  
I’ve written a free bonus chapter on tags you can download at buildingasecondbrain.com/bonuschapter.
...
gallery.  
I’ve never recognized the common stereotypes of the “tortured artist”—  
mercurial, unpredictable, brooding, and unreliable. My father is one of the most  
orderly, responsible people I’ve ever met. Yet this regularity didn’t take away from  
...
Building a Second Brain is really about _standardizing_ the way we work,  
...
This standardized routine is known as the _creative process_ , and it operates  
...
The _products_ of creativity are constantly changing and there is always a new  
...
But if you go one level deeper, to the _process_ of creativity, it is a very different  
...
and crossing out others in _The Godfather_ novel, at some point you must start  
...
tempting because they _feel_ like productivity. They feel like forward progress,  
...
quotes, which makes it seem far less daunting. All I have to do is build bridges
between the islands.
```
...
Ocean.  
To create an Archipelago of _Ideas_ , you divergently gather a group of ideas,  
...
The underlined links (which appear in green in my notes) are the sources I’m  
drawing on as research. Clicking a link will lead me not to the public web, where I  
can easily get distracted, but to another note _within_ my Second Brain containing

my full notes on that source.III There I will find all the details I might need, as well  
as a link back to the original work for my citations.  
Below each source, I’ve copied and pasted only the points I specifically want to  
...
```
A digital outline is far more malleable and flexible —you can add
...
```
The outline is interactive and multimedia —you can add not only text,
but images, GIFs, videos, attachments, diagrams, checkboxes, and more.
```

```
The outline is searchable —even if it gets long, you have a powerful search
feature to instantly call up any term you’re looking for.
```

```
The outline can be accessed and edited from anywhere —unlike a piece
...
difficulty performing at the same time: _choosing_ ideas (known as selection) and  
_arranging_ them into a logical flow (known as sequencing).  
...
energy and momentum to fuel tomorrow’s writing.IV  
...
```
Write down ideas for next steps: At the end of a work session, write
down what you think the next steps could be for the next one.
```

```
Write down the current status: This could include your current biggest
challenge, most important open question, or future roadblocks you expect.
```

```
Write down any details you have in mind that are likely to be
...
```
Write out your intention for the next work session: Set an intention
...
the _scope_ of the project. We can “dial it down” to a more manageable size, and we  
...
without fearing that I’ve wasted effort or that I’ll lose the results of my thinking  
forever. Knowing that I can always release a fix, update, or follow up on anything  
I’ve made in the past gives me the courage to share my ideas before they’re  
...
```
If you want to write a book, you could dial down the scope and write a
...
```
If you want to deliver a workshop for paying clients, you could dial it down
...
If you’d like to make a short film, start with a YouTube video, or if that’s
too intimidating, a livestream. If it’s still too much, record a rough cut on
your phone and send it to a friend.
```

```
If you want to design a brand identity for a company, start with a mock-up
...
```
Is there a book or article you could extract some excerpts from as
inspiration?
Are there websites that might have resources you could build upon?
```

```
Are there podcasts by experts you could subscribe to and listen to while
commuting or doing household chores?
```

```
Are there relevant IPs buried in other projects you’ve worked on in the
past?
```
...
one sitting see if you can complete a first pass on your project _using only the notes  
you’ve gathered in front of you_. No searching online, no browsing social media,  
...
_completing_ the entire project in one sitting. You are only creating the first iteration  
...
documentary on his work and life called _Wayne Lacson Forte: On My Way To Me_.

II. I first learned about the model of divergence and convergence from Design Thinking, an approach to  
...
III. If your notes app syncs with your computer, this also means that you can disconnect from the Internet  
...
# Your Second Brain is a practical system for enhancing your productivity and
...
demands on both the quality _and_ quantity of their output. Every ingredient in  
...
_mise en place_ , a culinary philosophy used in restaurants around the world.  
...
clean and organized _in the flow of the meals they are preparing_.  
...
practical techniques—as their “external brain.”^1 It gives them a way to externalize  
...
It’s not enough to have inner discipline. We also need to follow an _outer_  
...
```
Project Checklists: Ensure you start and finish your projects in a
consistent way, making use of past work.
Weekly and Monthly Reviews: Periodically review your work and life
...
former, I’ll introduce you to the Project Kickoff Checklist, and for the latter, the  
...
5. **Create an outline of collected notes and plan the project.** Finally, it’s time  
    to pull together the material I’ve gathered and create an outline (an Archipelago of  
    ...
    person. If it is a trip I’m planning to take, it might be a packing list and itinerary.  
    The important thing to remember as you move through this checklist is that  
    you are making a plan for how to tackle the project, _not executing the project itself_.  
...
keeping track of pending actions, like a digital to-do list.II  
...
I’ve been amazed that by being honest with myself about when a project has  
...
```
Answer postmortem questions: What did you learn? What did you do
well? What could you have done better? What can you improve for next
time?
Communicate with stakeholders: Notify your manager, colleagues,
...
```
Officially close out the project and celebrate: Send any last emails,
...
coach and author David Allen in his influential book _Getting Things Done_ .III He  
...
1. **Clear my email inbox.** I start by clearing my email inbox of any emails  
    ...
    in the rush of my other priorities, but I’ve found that if I let messages accumulate  
...
3. **Clear my computer desktop.** Next, I clear the files that have accumulated on  
    my computer desktop. I’ve found that if I let them accumulate week after week,  
...
4. **Clear my notes inbox.** By the time I get to the fourth step, the inbox in my  
    ...
    my email, calendar, and computer desktop. Plus all the other notes I’ve collected  
    over the course of the preceding week, which usually totals between five and  
    fifteen new notes in an average week.  
    At this point I’ll batch process them all at once, making quick, intuitive  
...
5. **Choose my tasks for the week.** There’s one final step in my Weekly Review.  
    ...
    areas.  
    The final step of my Weekly Review is to select the tasks I’m committing to for  
...
1. **Review and update my goals.** I start by reviewing my goals for the quarter  
    ...
    have?” and “What went unexpectedly and what can I learn from it?” I’ll take some  
...
2. **Review and update my project list.** Next, I’ll review and update my project  
...
3. **Review my areas of responsibility.** Now it’s time to do the same for my areas  
    of responsibility. I’ll think about the major areas of my life, such as my health,  
...
4. **Review someday/maybe tasks.** “Someday/maybe” is a special category for  
    ...
    to keep track of, but you don’t want them cluttering your priorities today. I’ll take  
...
5. **Reprioritize tasks.** Finally, once I’ve completed all the previous steps and have  
    ...
    tasks. I’m often surprised just how much can change in a month. To-dos that  
...
```
Noticing that an idea you have in mind could potentially be valuable and
...
Noticing that a note could use a better title—and changing it so it’s easier
for your future self to find it.
Noticing you could move or link a note to another project or area where it
will be more useful.
...
Noticing a chance to merge similar content from different notes into the
same note so it’s not spread around too many places.
Noticing when an IP that you already have could help someone else solve a
...
```
You notice that you need to buy a new computer because your current one
...
When you make your digital notes a _working_ environment, not just a storage  
...
even the first step.  
The checklists I’ve provided are a starting point to help you add some  
...
```
There’s no need to capture every idea; the best ones will always come back
around eventually.
```

```
There’s no need to clear your inbox frequently; unlike your to-do list,
there’s no negative consequence if you miss a given note.
```

```
There’s no need to review or summarize notes on a strict timeline; we’re not
trying to memorize their contents or keep them top of mind.
```

```
When organizing notes or files within PARA, it’s a very forgiving decision
...
immaculately organized knowledge. We are building a _working system_. Both in the  
...
performed _before_ the project starts. By asking what is likely to go wrong, you can take action to prevent it  
from happening in the first place.

II. Although outside the scope of this book, I’ve included my recommendations for task managers on  
multiple operating systems in the Second Brain Resource Guide at Buildingasecondbrain.com/resources.

III. The book _Getting Things Done_ , known as GTD, is a helpful counterpart to personal knowledge  
...
# For most of history, humanity’s challenge was how to acquire scarce
...
valuable. I’m saying that the greater the burden you place on your biological brain  
...
How do you know when you’ve begun making the shift to this new identity I’ve  
...
a response to the fear of not having enough.^1 We’ve been taught that information  
...
take care of yourself. Still, I’ve noticed time and again a phenomenon that  
...
communicate, learn, or work more effectively. As Ryder Carroll says in _The Bullet  
Journal Method_ , “Your singular perspective may patch some small hole in the vast  
...
In a 1966 book,I the British-Hungarian philosopher Michael Polanyi made an  
...
short. That’s because we are relying on _tacit knowledge_ , which is impossible to  
...
call out to you in the external world and gives you a sense of déjà vu. There is a  
...
discovery: writing in public.II I started a blog, and my very first blog post was  
...
I’ve spoken with so many people about their stories, and I’ve noticed time and  
...
Are you hoping to connect ideas and develop your ability to plan,
...
```
Are you committed to producing more and better output with less
...
```
7. Practice Progressive Summarization. Summarize a group of notes
...
8. Experiment with just one Intermediate Packet. Choose a project that
might be vague, sprawling, or simply hard, and pick just one piece of it to
...
9. Make progress on one deliverable. Choose a project deliverable you’re
...
10. **Schedule a Weekly Review.** Put a weekly recurring meeting with yourself  
...
11. **Assess your notetaking proficiency.** Evaluate your current notetaking  
    practices and areas for potential improvement using our free assessment  
    tool at Buildingasecondbrain.com/quiz.
    
12. **Join the PKM community.** On Twitter, LinkedIn, Substack, Medium,  
...
achieve within a reasonable period of time— _using_ your Second Brain is a lifelong  
practice. I recommend you revisit _Building a Second Brain_ at various points over  
...
I. _The Tacit Dimension_ , by Michael Polanyi
...
# I wrote this book to give you a new way to think about the knowledge that
...
of tagging.  
I’ve compiled a bonus chapter on how to create a tagging system for your  
...
# I’m sitting here at my usual writing spot weeks after my manuscript deadline has

passed. I’ve postponed the writing of these acknowledgments for as long as  
...
into me is difficult to put into words. But I’ll try.  
...
because you saw its potential and committed to seeing it realized. I’m deeply  
...
And I’m thankful to the Pen Name team for partnering with me in sharing my  
...
makes the _Building a Second Brain_ community so vibrant. This book is just as  
...
Forte and Valeria Vassão Forte, for giving me an upbringing that exposed me to  
...
person I’ve ever met. I consider it my highest privilege to walk alongside you as  
...
a variety of publications, such as the _New York Times_ , _The Atlantic_ , and _Harvard  
Business Review_. Find out more at Fortelabs.co.

```
SimonandSchuster.com
http://www.SimonandSchuster.com/Authors/Tiago-Forte
...
# If I have made a mistake somewhere in this book—either in attributing an idea to
...
1 Erik Brynjolfsson and Andrew McAfee, _The Second Machine Age: Work, Progress, and Prosperity in a  
Time of Brilliant Technologies_ (New York: W. W. Norton & Company, 2014), Amazon Kindle  
Location 1990 of 5689.

**CHAPTER 2: WHAT IS A SECOND BRAIN?**  
1 Nick Bilton, “Part of the Daily American Diet, 34 Gigabytes of Data,” _New York Times_ , December 9,  
2009, https://www.nytimes.com/2009/12/10/technology/10data.html.  
2 Daniel J. Levitin, “Hit the Reset Button in Your Brain,” _New York Times_ , August 9, 2014,  
...
3 Microsoft, _The Innovator’s Guide to Modern Note Taking: How businesses can harness the digital  
revolution_ , https://info.microsoft.com/rs/157-GQE-382/images/EN-  
US%2017034_MSFT_WWSurfaceModernNoteTaking_ebookRefresh_R2.pdf.  
4 IDC Corporate USA, _The Knowledge Quotient: Unlocking the Hidden Value of Information Using  
Search and Content Analytics_ , [http://pages.coveo.com/rs/coveo/images/IDC-Coveo-white-paper-](http://pages.coveo.com/rs/coveo/images/IDC-Coveo-white-paper-)  
248821.pdf.  
5 Robert Darnton, _The Case for Books: Past, Present, and Future_ (New York: PublicAffairs, 2009), 224.  
...
2 Deborah Chambers and Daniel Reisberg, “Can mental images be ambiguous?,” _Journal of Experimental  
Psychology: Human Perception and Performance_ 11, no. 3 (1985): 317–28,  
...
5 Robert J. Shiller, “What to Learn in College to Stay One Step Ahead of Computers,” _New York Times_ ,  
...
job, see Daniel Pink, _To Sell Is Human: The Surprising Truth About Moving Others_ (New York: Penguin  
Group, 2012), 6.  
7 Tim Ferriss, _Tools of Titans: The Tactics, Routines, and Habits of Billionaires, Icons, and World-Class  
Performers_ (New York: HarperCollins, 2017), 421.  
8 Each of these stories is real, but names have been changed to protect their anonymity.  
9 Erwin Raphael McManus, _The Artisan Soul: Crafting Your Life into a Work of Art_ (New York:  
...
4 Gian-Carlo Rota, _Indiscrete Thoughts_ (Boston: Birkhäuser Boston, 1997), 202.  
5 James Gleick, _Genius: The Life and Science of Richard Feynman_ (New York: Open Road Media, 2011),

6 Raymond S. Nickerson, “Confirmation Bias: A Ubiquitous Phenomenon in Many Guises,” _Review of  
General Psychology 2_ , no. 2 (June 1998): 175–220, https://journals.sagepub.com/doi/10.1037/1089-  
2680.2.2.175.  
7 Marianne Freiberger, “Information is surprise,” _Plus Magazine_ , March 24, 2015,  
https://plus.maths.org/content/information-surprise.  
8 Dacher Keltner and Paul Ekman, “The Science of ‘Inside Out,’ ” _New York Times_ , July 3, 2015,  
https://www.nytimes.com/2015/07/05/opinion/sunday/the-science-of-inside-out.html.  
9 Stephen Wendel, _Designing for Behavior Change: Applying Psychology and Behavioral Economics_  
(Sebastopol, CA: O’Reilly Media, 2013).  
10 Zachary A. Rosner et al., “The Generation Effect: Activating Broad Neural Circuits During Memory  
Encoding,” _Cortex_ 49, no. 7 (July–August 2013), 1901–1909,  
https://doi.org/10.1016/j.cortex.2012.09.009.  
11 James W. Pennebaker, “Writing about Emotional Experiences as a Therapeutic Process,” _Psychological  
Science_ 8, no. 3 (May 1997), 162–66.

**CHAPTER 5: ORGANIZE—SAVE FOR ACTIONABILITY**  
1 Twyla Tharp, _The Creative Habit: Learn It and Use It For Life_ (New York: Simon & Schuster, 2003), 80.  
2 Joan Meyers-Levy and Rui Zhu, “The Influence of Ceiling Height: The Effect of Priming on the Type  
of Processing That People Use,” _Journal of Consumer Research_ 34, no. 2 (2007): 174–86,  
https://doi.org/10.1086/519146.  
3 Adam Davidson, “What Hollywood Can Teach Us About the Future of Work,” _New York Times  
Magazine_ , May 5, 2015.

**CHAPTER 6: DISTILL—FIND THE ESSENCE**  
1 “Inside Francis Ford Coppola’s _Godfather_ Notebook”:  
...
3 _Francis Coppola’s Notebook_ , imdb.com, 2001, https://www.imdb.com/title/tt0881915/.  
4 Jess Wise, “How the Brain Stops Time,” _Psychology Today_ , March 13, 2010,  
https://www.psychologytoday.com/us/blog/extreme-fear/201003/how-the-brain-stops-time.  
5 Meghan Telpner, _Academy of Culinary Nutrition_ , Academy of Culinary Nutrition (blog),  
...
1 Octavia E. Butler, _Bloodchild and Other Stories: Positive Obsession_ (New York: Seven Stories, 2005), 123–

2 Lynell George, _A Handful of Earth, A Handful of Sky: The World of Octavia Butler_ (Santa Monica:  
Angel City Press, 2020).  
3 Dan Sheehan, “Octavia Butler has finally made the _New York Times_ Best Seller list,” LitHub.com,  
...
_ACM SIGCHI Bulletin_ 27, no. 3 (1995), 39–43, https://doi.org/10.1145/221296.221307. Joseph A.  
Maxwell, “Book Review: Bergman, M. M. (Ed.). (2008). Advances in Mixed Method Research.  
Thousand Oaks, Ca: Sage,” _Journal of Mixed Methods Research_ 3, no. 4 (2009), 411–13,  
...
reference by location versus name,” _ACM Digital Library_ 4, no. 1 (1986),  
...
1 Dan Charnas, _Work Clean: The Life-Changing Power of Mise-en-Place to Organize Your Life, Work, and  
Mind_ (Emmaus, PA: Rodale Books, 2016).

**CHAPTER 10: THE PATH OF SELF-EXPRESSION**  
1 Lynne Twist, _The Soul of Money_ (New York City: W. W. Norton & Company, 2017), 43.
...
batch processing of notes, 212. _See also_ Monthly Reviews; Weekly Reviews  
...
brain. _See_ biological brain; Second Brain  
...
Building a Second Brain system. _See also_ Second Brain  
...
origins of, 15–16  
overview, 2–5  
_Bullet Journal Method, The_ (Carroll), 232  
bullet points, 125  
...
Carroll, Ryder, 232  
case files, 57  
_Case for Books, The_ (Darnton), 19–20  
Cathedral Effect, 84–86  
_Challenger_ space shuttle disaster, 62  
Chambers, Deborah, 35  
China, 20n  
choreography, 81–84  
...
Clear, James, 197  
code libraries, 57  
CODE Method, 33 , 42–49, 180 , 198 , 237–38. _See also_ Capture; Distill; Express; Organize  
...
as a remix, 169  
_Creativity: The Magic Synthesis_ (Arieti), 175  
Crick, Francis, 34–35  
...
_Designing for Behavior Change_ (Wendel), 71–72  
Design Thinking, 178n  
detachment gain, 77n  
_Detachment Gain, The: The Advantage of Thinking Out Loud_ (Reisberg), 77n  
...
explained, 46–47  
Progressive Summarization in ( _see_ Progressive Summarization)  
...
convergence and, 180  
explained, 47–49  
Intermediate Packets in ( _see_ Intermediate Packets)  
...
_Extended Mind, The_ (Paul), 17 , 30n  
...
_Francis Coppola’s Notebook_ (documentary), 115  
...
_Genius: The Life and Science of Richard Feynman_ (Gleick), 62–63  
_Getting Things Done_ (Allen), 9 , 212 , 212n  
Gleick, James, 62–63  
goals  
...
_Godfather, The_ (film), 113–16, 179  
Google Docs, 40n, 110  
Google Keep, 39  
grid code, 43n
...
Hofstra College, 114  
Hollywood model, 91  
_Hollywood Reporter_ , 114  
hook books, 57  
“How the Brain Stops Time” _(Psychology Today)_ , 121 , 123 , 124 , 125  
_How to Take Smart Notes_ (Ahrens), 141n  
human capital, 14  
...
intuition, 71–72  
IPs. _See_ Intermediate Packets  
Iriki, Atsushi, 22n  
_Is This Anything?_ (Seinfeld), 56
...
kitbashing, 169  
kitchen organization analogy, 103–5  
knowledge. _See also_ personal knowledge management  
...
Knowledge Management, 2n. _See also_ personal knowledge management  
...
Memex, 4n, 30n  
memory(ies), 18–19, 59. _See also_ remember; remembering  
Microsoft, 18  
...
Moser, May-Britt, 43n  
musings, 59  
_MythBusters_ (television program), 169

N  
_New Method of Making Common-Place Books, A_ (Locke), 122n  
_New York Times_ , 17 , 91  
...
actionability and ( _see_ actionability)  
...
P  
PARA, 87–111, 160 , 163 , 165 , 204 , 214 , 238. _See also_ Archives; Areas; Projects; Resources  
...
_Parable of the Sower, The_ (Butler), 147–48  
...
_Picasso’s Bull_ (drawing), 134–36, 137  
pillow books, 20n  
PKM. _See_ personal knowledge management  
...
_Psychology Today_ article, 121 , 123 , 124 , 125
...
Second Brain. _See also_ Building a Second Brain system  
...
space, designing for ideas. _See_ Cathedral Effect  
...
T  
_Tacit Dimension, The_ (Polanyi), 233n  
tacit knowledge, 233  
tagging, 88 , 88n  
...
Watson, James, 34–35  
Wayback Machine, 72n  
_Wayne Lacson Forte: On My Way To Me_ (documentary), 176n  
web clipper apps, 73 , 74  
Weekly Reviews, 102 , 200 , 212–15, 240  
_Why Information Grows_ (Hidalgo), 58n  
...
writing things down, 2. _See also_ notetaking  
...
[http://www.simonspeakers.com.](http://www.simonspeakers.com.)  
